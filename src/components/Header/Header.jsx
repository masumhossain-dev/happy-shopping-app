...
const Header = () => {
    ...
    return (
        ...
        <nav className="navbar bg-primary text-white flex justify-center h-20">
            ...
            {user ? <button className='btn btn-outline border-white text-white ms-5' onClick={handleLogOut}>Logout</button> : <div>
                <button className="btn btn-outline border-white text-white me-5 ms-6 text-lg"><Link to="/login">Login</Link></button>
