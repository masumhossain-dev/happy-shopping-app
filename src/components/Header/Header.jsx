    ...
    return (
        ...
        <nav className="navbar bg-primary text-white flex justify-center h-20">
            ...
            <div>
                ...
                <Link to="/inventory" className="btn btn-ghost normal-case text-xl me-6">Inventory</Link>
            </div>
            <div>
                <button className="btn btn-outline me-5 text-white"><Link to="/login">Login</Link></button>
                <button className="btn glass text-white"><Link to="/register">Register</Link></button>
            </div>
